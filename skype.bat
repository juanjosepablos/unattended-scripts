...
:: URL|ALL|http://www.skype.com/go/getskype-full|packages/skype/skype-6.13.exe
:: More info:
...
todo.pl "%Z%\packages\skype\skype-6.13.exe /VERYSILENT /NORESTART /NOGOOGLE /LOG /NOIE"
