...
:: URL|ALL|http://openhardwaremonitor.org/files/openhardwaremonitor-v0.5.1-beta.zip|packages/openhardwaremonitor-v0.5.1-beta.zip
...
todo.pl "\"%ProgramFiles%\7-Zip\7z\" x -o\"%ProgramFiles%\" %Z%\packages\openhardwaremonitor-v0.5.1-beta.zip"
